...
image_name="golang-dev"
local_image="${image_name}:latest"
registry_address="localhost:5000"
registry_image="${registry_address}/${image_name}:latest"

echo "Building image: $local_image from context: $build_context"
...
echo "Pushing image to registry: $registry_address"
